...
namespace Bobby
{
    ...
    public class CreditsGameComponent : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, SamplerState.LinearClamp, DepthStencilState.None, RasterizerState.CullNone, game.effect);
            spriteBatch.DrawString(game.font, "© 2011 Nooskewl/Studio Dereka", new Vector2(60, 345), new Color(0xff, 0xd8, 0));
            spriteBatch.DrawString(game.font, "Special thanks to:", new Vector2(60, 385), new Color(255, 255, 255));
            spriteBatch.DrawString(game.font, "Oscar Giner and", new Vector2(100, 425), new Color(200, 200, 200));
            spriteBatch.DrawString(game.font, "Kris Asick for level design", new Vector2(100, 465), new Color(200, 200, 200));
            spriteBatch.DrawString(game.font, "Jon Baken for the tune", new Vector2(100, 505), new Color(200, 200, 200));
